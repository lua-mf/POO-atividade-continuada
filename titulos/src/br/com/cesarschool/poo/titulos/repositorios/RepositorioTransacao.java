...
public class RepositorioTransacao extends RepositorioGeral {
	...
	public Transacao[] buscarTodasTransacoes() {
		List<String> linhas = lerArquivo(); // Lê todas as linhas do arquivo
		List<Transacao> transacoes = new ArrayList<>();

		// Converte cada linha em um objeto Transacao
		for (String linha : linhas) {
			String[] dados = linha.split(";");
			transacoes.add(parseTransacao(dados));
		}
